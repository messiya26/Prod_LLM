...
let BlogController = class BlogController {
    ...
    create(req, body) { return this.blogService.create(req.user.id, body); }
    update(id, body) { return this.blogService.update(id, body); }
    delete(id) { return this.blogService.delete(id); }
};
