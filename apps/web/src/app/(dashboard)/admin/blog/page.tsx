        ...
        <div className="grid gap-3">
          {filtered.map(p => (
            <div key={p.id} className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-4 flex items-center gap-4 hover:border-gold/10 transition-all">
              {p.image ? <img src={p.image.startsWith("/") ? `https://prod-llm.onrender.com${p.image}` : p.image} alt="" className="w-16 h-16 rounded-lg object-cover flex-shrink-0" /> : <div className="w-16 h-16 rounded-lg bg-white/[0.04] flex items-center justify-center text-white/15 flex-shrink-0"><FaImage className="text-xl" /></div>}
            ...
            <div className="p-5 space-y-4">
              ...
              <div><label className="block text-white/40 text-xs mb-1.5 uppercase">Image</label>
                <div className="flex items-center gap-3">
                  ...
                  {form.image && <img src={form.image.startsWith("/") ? `https://prod-llm.onrender.com${form.image}` : form.image} alt="" className="w-12 h-12 rounded-lg object-cover" />}
                </div>
              </div>
